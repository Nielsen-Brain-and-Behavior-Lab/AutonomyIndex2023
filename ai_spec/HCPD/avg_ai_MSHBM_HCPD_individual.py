...
with open('/fslgroup/fslg_spec_networks/compute/code/HCPD_analysis/ai_spec/REST/avg_ai/REST_ids.txt', 'r') as f:
...
for sub1 in subject_ids:
	...
	for network in range(0,18): #Range must be set to actual number of networks +1
		...
		# path to ai output
		sec_dir: str="/fslgroup/fslg_csf_autism/compute/HCPD_analysis/parc_output_fs6_HCPD_REST/quant_metrics/ai_values"
...
r_name = "MSHBM_LONG_AVG_AI_HCPD_230314.csv" #file name
