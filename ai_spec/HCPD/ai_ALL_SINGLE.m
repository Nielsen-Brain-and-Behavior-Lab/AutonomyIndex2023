...
% Set paths
project_dir = '/fslgroup/fslg_csf_autism/compute/HCPD_analysis/parc_output_fs6_HCPD_REST/quant_metrics/FC_matrices';
out_dir = '/fslgroup/fslg_csf_autism/compute/HCPD_analysis/parc_output_fs6_HCPD_REST/quant_metrics/ai_values';
sublist = [ "SUB" ];
