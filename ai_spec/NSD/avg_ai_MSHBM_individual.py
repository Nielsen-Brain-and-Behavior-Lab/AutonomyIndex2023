...
with open('/fslgroup/fslg_spec_networks/compute/code/NSD_analysis/ai_spec/REST/ALL/individual_ai/subjids.txt', 'r') as f:
...
for sub1 in subject_ids:
	...
	for network in range(0,18): #Range must be set to actual number of networks +1
		...
		test_dir: str="/fslgroup/fslg_fun_conn/compute/NSD_analysis/parc_output_fs6_NSD_12_REST/generate_individual_parcellations/ind_parcellation/test_set"
		...
		# path to ai output
		sec_dir: str="/fslgroup/fslg_fun_conn/compute/NSD_analysis/parc_output_fs6_NSD_12_REST/quant_metrics/ai_values"
...
r_name = "MSHBM_LONG_AVG_AI_NSD_ALL_REST_230221.csv" #file name
