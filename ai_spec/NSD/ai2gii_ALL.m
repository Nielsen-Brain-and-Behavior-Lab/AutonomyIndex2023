...
%% NSD TASK REST ALL Analysis

% Set paths and variables
out_dir = '/fslgroup/fslg_fun_conn/compute/NSD_analysis/parc_output_fs6_NSD_12_REST/quant_metrics/ai_values';
gifti_template_dir = '/fslgroup/fslg_spec_networks/compute/results/fsaverage_surfaces';

%Load text file
    filename = '/nobackup/scratch/grp/fslg_spec_networks/code/NSD_analysis/ai_spec/REST/ALL/individual_ai/subjids.txt';
    delimiter = {''};
