...
SUBJ_OUT_DIR=/fslgroup/grp_nsd/compute/HCPD_analysis/parc_output_fs6_HCPD_REST/quant_metrics/FC_matrices
SUBJ_CODE_DIR=/fslgroup/fslg_spec_networks/compute/code/HCPD_analysis/FC_matrices/REST/subj_scripts/${SUB}/ses-${SES}
cd $SUBJ_CODE_DIR
