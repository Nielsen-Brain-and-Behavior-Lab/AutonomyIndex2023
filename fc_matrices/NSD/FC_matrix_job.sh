...
SUBJ_OUT_DIR=/fslgroup/fslg_fun_conn/compute/NSD_analysis/parc_output_fs6_NSD_12_REST/quant_metrics/FC_matrices
SUBJ_CODE_DIR=/fslgroup/fslg_spec_networks/compute/code/NSD_analysis/FC_matrices/REST/ALL/subj_scripts/${SUB}/ses-${SES}
cd $SUBJ_CODE_DIR
