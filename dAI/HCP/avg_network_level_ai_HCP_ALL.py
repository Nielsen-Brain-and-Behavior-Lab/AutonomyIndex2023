...
with open('/fslgroup/fslg_spec_networks/compute/code/HCP_analysis/ai_spec/ALL/network_level_ai/subjids.txt', 'r') as f:
...
for seed_network in range(1,18):
	...
	for sub1 in subject_ids:
		...
		for network in range(0,18): #Range must be set to actual number of networks +1
			...
			sec_dir: str="/fslgroup/grp_hcp/compute/HCP_analysis/parc_output_fs6_HCP_ALL/quant_metrics/network_level_ai"
	...
	r_name = "MSHBM2019_LONG_NETWORK_LEVEL_AI_NETWORK-" + str(seed_network) + "_HCP_230421.csv" #file name	
